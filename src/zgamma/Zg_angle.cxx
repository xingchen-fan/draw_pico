...
int main() {
    ...
    string mc_path( "/net/cms17/cms17r0/pico/NanoAODv9/htozgamma_deathvalley_v1/2017/mc/merged_zgmc_llg/");
    ...
    auto proc_smzg  = Process::MakeShared<Baby_pico>("SM Z#gamma", sig, TColor::GetColor("#16bac5"),{mc_path+"*ZGToLLG*"}, trigs);
    auto proc_dy    = Process::MakeShared<Baby_pico>("DY", sig,TColor::GetColor("#ffb400"),{mc_path+"*DYJetsToLL_M-50*"},  trigs && "stitch_dy");
    auto proc_ggf =  Process::MakeShared<Baby_pico>("HToZ#gamma ggF(x100)", sig, kRed ,{sig_path+"*GluGlu*.root"},   trigs);
    ...
    NamedFunc llphoton_cuts("llphoton_m[0]+ll_m[0]>185 && llphoton_m[0] > 100 && llphoton_m[0] < 180 && photon_pt[0]/llphoton_m[0]>15./110");
    NamedFunc baseline("nll > 0 && nphoton > 0 && ll_m[0] > 50");
